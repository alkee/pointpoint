// from https://github.com/mattatz/unity-transform-control
...
namespace mattatz.TransformControl
{
    public class TransformControl : MonoBehaviour
    {
        ...
        private Dictionary<TransformDirection, Vector3> axes = new Dictionary<TransformDirection, Vector3>() {
            { TransformDirection.X, Vector3.right },
            { TransformDirection.Y, Vector3.up },
            { TransformDirection.Z, Vector3.forward }
        };

        private Matrix4x4[] matrices = new Matrix4x4[] {
        ...
        private TransformDirection selected = TransformDirection.None;

        #region Circumference

        private const int SPHERE_RESOLUTION = 32;
        private List<Vector3> circumX;
        private List<Vector3> circumY;
        private List<Vector3> circumZ;

        #endregion Circumference
        ...
        */
        ...
        private bool PickOrthogonal(Vector3 mouse)
        {
            var cam = Camera.main;
        ...
        private bool PickSphere(Vector3 mouse)
        {
            var cam = Camera.main;
        ...
        private void GetCircumference(int resolution, out List<Vector3> x, out List<Vector3> y, out List<Vector3> z)
        {
            x = new List<Vector3>();
            y = new List<Vector3>();
            z = new List<Vector3>();
        ...
        private void DrawMesh(Mesh mesh, Matrix4x4 m, Color color)
        {
